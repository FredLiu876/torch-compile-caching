...
# kernel path: ./local_cache/yi/cyihme7t354xdekku5rks7waotqdnz3mpo47q3uhqjtr5ixrgolb.py
...
# kernel path: ./local_cache/xd/cxdna3iuiarg5df5zltn5jik5bvuuyvpn2rygiz2q4ninczsg7t7.py
...
# kernel path: ./local_cache/jj/cjjwjnmyb5ylskx6e3eg4yueoaqwlte7kuhtcnu2a4ncpavggv5i.py
...
# kernel path: ./local_cache/6w/c6w7ysj4hzbjrc3ky2bllh4hizall6zebpysmidywv3kv2zvm2ex.py
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_4 = rand_strided((1, 3), (3, 1), device='cuda:0', dtype=torch.int64)
