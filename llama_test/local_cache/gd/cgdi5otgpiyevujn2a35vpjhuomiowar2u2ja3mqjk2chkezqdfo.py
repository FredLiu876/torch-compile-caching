...
# kernel path: ./local_cache/3j/c3jfs7i2n4ghyv7a6upiokqmiavouth3wwa2rl3crrbt2daxwgbc.py
...
# kernel path: ./local_cache/lg/clge5s4bexuzcuiyyk6wdagiu6uovldxslqomkn47ipii2cfttub.py
...
#   hidden_states_320 => convert_element_type_644
# Graph fragment:
#   %mul_12479 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_652, %primals_295), kwargs = {})
#   %convert_element_type_644 : [num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_9781, torch.float32), kwargs = {})
...
# kernel path: ./local_cache/xl/cxlrxrodwckhkjilnndnskbsphjhmrmsaul3vbslmse6b5ulvyvz.py
...
# kernel path: ./local_cache/ye/cyebsf3anhyuxewgys2gminc36tn6uo6fybpryty274aelqwsxrt.py
...
#   %mul_12492 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_9833, %primals_291), kwargs = {})
...
# kernel path: ./local_cache/b6/cb6vgngmgusaq42w5g3gqwky4pfaktesyo3iqr644b5byz4ctmzl.py
...
# kernel path: ./local_cache/kj/ckj4lr334w3hitrlnx6ds7ziqksk5biix3yg7b5s733lktagsgp6.py
...
# kernel path: ./local_cache/di/cdiwpjaki63dio4z7a3pkipwfghc77d3yfkhna4ozve4famho2gf.py
...
# kernel path: ./local_cache/qg/cqggemris3j5tumfbsvlgzysp62v6daxvhvyrakgx7jceeylpicd.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.clone]
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: ./local_cache/si/csimob75y2oxrzkjjxnnndguan5m72uekzh52gegv7aol5f2fzci.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.clone]
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: ./local_cache/a5/ca52bl5squdroeaanlxdwl3jwdjj2wexli2lmyaxagznldaazf2w.py
...
#   %mul_12504 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_9841, %primals_286), kwargs = {})
...
# kernel path: ./local_cache/sk/cska3fwz53boidgxgnhdyzwobijaqtfl73qndyo6jscov76o2orn.py
...
# kernel path: ./local_cache/ho/choyh3jijtvaaoyhoyvky737oi4kgipbhuu3mersun2kig4kgcax.py
...
#   %mul_13267 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10205, %primals_12), kwargs = {})
...
# kernel path: ./local_cache/m3/cm3xmogfip2jlis6ndgz42hay2axvskpa64eoxadbtfgyk5gvt2c.py
...
#   %mul_13279 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10213, %primals_7), kwargs = {})
...
# kernel path: ./local_cache/le/cleebz4qsuv6x3uay77iffht6w22pvdm2rpphczmwg6tlnbdvmxa.py
...
def call(args):
    ...
    assert_size_stride(constant_pad_nd, (1, 1, s0, 8 + s0 + (-1)*(s0 % 8)), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 8 + s0 + (-1)*(s0 % 8), 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [hidden_states_320], Original ATen: [aten.mul, aten._to_copy, aten.sum, aten.div, aten.pow, aten.add]
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_2.run(buf4, primals_295, add_9781, rsqrt_64, s0, 4096, stream=stream0)
        del add_9781
        del primals_295
        del rsqrt_64
        ...
        # Topologically Sorted Source Nodes: [hidden_states_316], Original ATen: [aten.add, aten.mul, aten._to_copy, aten.sum, aten.div, aten.pow]
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf15, buf9, buf12, primals_291, add_9716, rsqrt_63, s0, 4096, stream=stream0)
        del primals_291
        ...
        # Topologically Sorted Source Nodes: [hidden_states_310], Original ATen: [aten.add, aten.mul, aten._to_copy, aten.sum, aten.div, aten.pow]
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf34, buf25, buf28, buf31, primals_286, add_9478, rsqrt_62, s0, 4096, stream=stream0)
        del primals_286
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf45, buf39, buf42, primals_282, add_9413, rsqrt_61, s0, 4096, stream=stream0)
        del primals_282
        ...
        del permute_406
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf48 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf47, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_94, view_618, view_619, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_120, getitem_121, getitem_122, getitem_123, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_94
        del getitem_120
        del getitem_121
        del getitem_122
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf64, buf55, buf58, buf61, primals_277, add_9175, rsqrt_60, s0, 4096, stream=stream0)
        del primals_277
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf75, buf69, buf72, primals_273, add_9110, rsqrt_59, s0, 4096, stream=stream0)
        del primals_273
        ...
        del permute_439
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf78 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf77, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_91, view_598, view_599, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_116, getitem_117, getitem_118, getitem_119, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_91
        del getitem_116
        del getitem_117
        del getitem_118
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf94, buf85, buf88, buf91, primals_268, add_8872, rsqrt_58, s0, 4096, stream=stream0)
        del primals_268
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf105, buf99, buf102, primals_264, add_8807, rsqrt_57, s0, 4096, stream=stream0)
        del primals_264
        ...
        del permute_472
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf108 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf107, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_88, view_578, view_579, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_112, getitem_113, getitem_114, getitem_115, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_88
        del getitem_112
        del getitem_113
        del getitem_114
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf124, buf115, buf118, buf121, primals_259, add_8569, rsqrt_56, s0, 4096, stream=stream0)
        del primals_259
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf135, buf129, buf132, primals_255, add_8504, rsqrt_55, s0, 4096, stream=stream0)
        del primals_255
        ...
        del permute_505
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf138 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf137, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_85, view_558, view_559, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_108, getitem_109, getitem_110, getitem_111, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_85
        del getitem_108
        del getitem_109
        del getitem_110
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf154, buf145, buf148, buf151, primals_250, add_8266, rsqrt_54, s0, 4096, stream=stream0)
        del primals_250
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf165, buf159, buf162, primals_246, add_8201, rsqrt_53, s0, 4096, stream=stream0)
        del primals_246
        ...
        del permute_538
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf168 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf167, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_82, view_538, view_539, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_104, getitem_105, getitem_106, getitem_107, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_82
        del getitem_104
        del getitem_105
        del getitem_106
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf184, buf175, buf178, buf181, primals_241, add_7963, rsqrt_52, s0, 4096, stream=stream0)
        del primals_241
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf195, buf189, buf192, primals_237, add_7898, rsqrt_51, s0, 4096, stream=stream0)
        del primals_237
        ...
        del permute_571
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf198 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf197, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_79, view_518, view_519, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_100, getitem_101, getitem_102, getitem_103, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_79
        del getitem_100
        del getitem_101
        del getitem_102
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf214, buf205, buf208, buf211, primals_232, add_7660, rsqrt_50, s0, 4096, stream=stream0)
        del primals_232
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf225, buf219, buf222, primals_228, add_7595, rsqrt_49, s0, 4096, stream=stream0)
        del primals_228
        ...
        del permute_604
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf228 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf227, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_76, view_498, view_499, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_96, getitem_97, getitem_98, getitem_99, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_76
        del getitem_96
        del getitem_97
        del getitem_98
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf244, buf235, buf238, buf241, primals_223, add_7357, rsqrt_48, s0, 4096, stream=stream0)
        del primals_223
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf255, buf249, buf252, primals_219, add_7292, rsqrt_47, s0, 4096, stream=stream0)
        del primals_219
        ...
        del permute_637
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf258 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf257, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_73, view_478, view_479, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_92, getitem_93, getitem_94, getitem_95, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_73
        del getitem_92
        del getitem_93
        del getitem_94
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf274, buf265, buf268, buf271, primals_214, add_7054, rsqrt_46, s0, 4096, stream=stream0)
        del primals_214
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf285, buf279, buf282, primals_210, add_6989, rsqrt_45, s0, 4096, stream=stream0)
        del primals_210
        ...
        del permute_670
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf288 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf287, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_70, view_458, view_459, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_88, getitem_89, getitem_90, getitem_91, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_70
        del getitem_88
        del getitem_89
        del getitem_90
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf304, buf295, buf298, buf301, primals_205, add_6751, rsqrt_44, s0, 4096, stream=stream0)
        del primals_205
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf315, buf309, buf312, primals_201, add_6686, rsqrt_43, s0, 4096, stream=stream0)
        del primals_201
        ...
        del permute_703
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf318 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf317, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_67, view_438, view_439, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_84, getitem_85, getitem_86, getitem_87, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_67
        del getitem_84
        del getitem_85
        del getitem_86
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf334, buf325, buf328, buf331, primals_196, add_6448, rsqrt_42, s0, 4096, stream=stream0)
        del primals_196
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf345, buf339, buf342, primals_192, add_6383, rsqrt_41, s0, 4096, stream=stream0)
        del primals_192
        ...
        del permute_736
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf348 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf347, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_64, view_418, view_419, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_80, getitem_81, getitem_82, getitem_83, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_64
        del getitem_80
        del getitem_81
        del getitem_82
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf364, buf355, buf358, buf361, primals_187, add_6145, rsqrt_40, s0, 4096, stream=stream0)
        del primals_187
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf375, buf369, buf372, primals_183, add_6080, rsqrt_39, s0, 4096, stream=stream0)
        del primals_183
        ...
        del permute_769
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf378 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf377, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_61, view_398, view_399, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_76, getitem_77, getitem_78, getitem_79, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_61
        del getitem_76
        del getitem_77
        del getitem_78
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf394, buf385, buf388, buf391, primals_178, add_5842, rsqrt_38, s0, 4096, stream=stream0)
        del primals_178
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf405, buf399, buf402, primals_174, add_5777, rsqrt_37, s0, 4096, stream=stream0)
        del primals_174
        ...
        del permute_802
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf408 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf407, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_58, view_378, view_379, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_72, getitem_73, getitem_74, getitem_75, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_58
        del getitem_72
        del getitem_73
        del getitem_74
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf424, buf415, buf418, buf421, primals_169, add_5539, rsqrt_36, s0, 4096, stream=stream0)
        del primals_169
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf435, buf429, buf432, primals_165, add_5474, rsqrt_35, s0, 4096, stream=stream0)
        del primals_165
        ...
        del permute_835
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf438 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf437, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_55, view_358, view_359, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_68, getitem_69, getitem_70, getitem_71, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_55
        del getitem_68
        del getitem_69
        del getitem_70
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf454, buf445, buf448, buf451, primals_160, add_5236, rsqrt_34, s0, 4096, stream=stream0)
        del primals_160
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf465, buf459, buf462, primals_156, add_5171, rsqrt_33, s0, 4096, stream=stream0)
        del primals_156
        ...
        del permute_868
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf468 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf467, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_52, view_338, view_339, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_64, getitem_65, getitem_66, getitem_67, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_52
        del getitem_64
        del getitem_65
        del getitem_66
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf484, buf475, buf478, buf481, primals_151, add_4933, rsqrt_32, s0, 4096, stream=stream0)
        del primals_151
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf495, buf489, buf492, primals_147, add_4868, rsqrt_31, s0, 4096, stream=stream0)
        del primals_147
        ...
        del permute_901
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf498 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf497, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_49, view_318, view_319, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_60, getitem_61, getitem_62, getitem_63, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_49
        del getitem_60
        del getitem_61
        del getitem_62
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf514, buf505, buf508, buf511, primals_142, add_4630, rsqrt_30, s0, 4096, stream=stream0)
        del primals_142
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf525, buf519, buf522, primals_138, add_4565, rsqrt_29, s0, 4096, stream=stream0)
        del primals_138
        ...
        del permute_934
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf528 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf527, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_46, view_298, view_299, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_56, getitem_57, getitem_58, getitem_59, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_46
        del getitem_56
        del getitem_57
        del getitem_58
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf544, buf535, buf538, buf541, primals_133, add_4327, rsqrt_28, s0, 4096, stream=stream0)
        del primals_133
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf555, buf549, buf552, primals_129, add_4262, rsqrt_27, s0, 4096, stream=stream0)
        del primals_129
        ...
        del permute_967
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf558 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf557, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_43, view_278, view_279, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_52, getitem_53, getitem_54, getitem_55, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_43
        del getitem_52
        del getitem_53
        del getitem_54
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf574, buf565, buf568, buf571, primals_124, add_4024, rsqrt_26, s0, 4096, stream=stream0)
        del primals_124
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf585, buf579, buf582, primals_120, add_3959, rsqrt_25, s0, 4096, stream=stream0)
        del primals_120
        ...
        del permute_1000
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf588 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf587, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_40, view_258, view_259, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_48, getitem_49, getitem_50, getitem_51, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_40
        del getitem_48
        del getitem_49
        del getitem_50
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf604, buf595, buf598, buf601, primals_115, add_3721, rsqrt_24, s0, 4096, stream=stream0)
        del primals_115
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf615, buf609, buf612, primals_111, add_3656, rsqrt_23, s0, 4096, stream=stream0)
        del primals_111
        ...
        del permute_1033
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf618 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf617, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_37, view_238, view_239, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_44, getitem_45, getitem_46, getitem_47, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_37
        del getitem_44
        del getitem_45
        del getitem_46
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf634, buf625, buf628, buf631, primals_106, add_3418, rsqrt_22, s0, 4096, stream=stream0)
        del primals_106
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf645, buf639, buf642, primals_102, add_3353, rsqrt_21, s0, 4096, stream=stream0)
        del primals_102
        ...
        del permute_1066
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf648 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf647, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_34, view_218, view_219, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_40, getitem_41, getitem_42, getitem_43, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_34
        del getitem_40
        del getitem_41
        del getitem_42
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf664, buf655, buf658, buf661, primals_97, add_3115, rsqrt_20, s0, 4096, stream=stream0)
        del primals_97
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf675, buf669, buf672, primals_93, add_3050, rsqrt_19, s0, 4096, stream=stream0)
        del primals_93
        ...
        del permute_1099
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf678 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf677, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_31, view_198, view_199, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_36, getitem_37, getitem_38, getitem_39, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_31
        del getitem_36
        del getitem_37
        del getitem_38
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf694, buf685, buf688, buf691, primals_88, add_2812, rsqrt_18, s0, 4096, stream=stream0)
        del primals_88
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf705, buf699, buf702, primals_84, add_2747, rsqrt_17, s0, 4096, stream=stream0)
        del primals_84
        ...
        del permute_1132
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf708 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf707, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_28, view_178, view_179, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_32, getitem_33, getitem_34, getitem_35, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_28
        del getitem_32
        del getitem_33
        del getitem_34
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf724, buf715, buf718, buf721, primals_79, add_2509, rsqrt_16, s0, 4096, stream=stream0)
        del primals_79
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf735, buf729, buf732, primals_75, add_2444, rsqrt_15, s0, 4096, stream=stream0)
        del primals_75
        ...
        del permute_1165
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf738 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf737, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_25, view_158, view_159, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_28, getitem_29, getitem_30, getitem_31, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_25
        del getitem_28
        del getitem_29
        del getitem_30
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf754, buf745, buf748, buf751, primals_70, add_2206, rsqrt_14, s0, 4096, stream=stream0)
        del primals_70
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf765, buf759, buf762, primals_66, add_2141, rsqrt_13, s0, 4096, stream=stream0)
        del primals_66
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf784, buf775, buf778, buf781, primals_61, add_1903, rsqrt_12, s0, 4096, stream=stream0)
        del primals_61
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf795, buf789, buf792, primals_57, add_1838, rsqrt_11, s0, 4096, stream=stream0)
        del primals_57
        ...
        del permute_1231
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf798 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf797, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_19, view_118, view_119, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_20, getitem_21, getitem_22, getitem_23, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_19
        del getitem_20
        del getitem_21
        del getitem_22
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf814, buf805, buf808, buf811, primals_52, add_1600, rsqrt_10, s0, 4096, stream=stream0)
        del primals_52
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf825, buf819, buf822, primals_48, add_1535, rsqrt_9, s0, 4096, stream=stream0)
        del primals_48
        ...
        del permute_1264
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf828 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf827, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_16, view_98, view_99, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_16, getitem_17, getitem_18, getitem_19, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_16
        del getitem_16
        del getitem_17
        del getitem_18
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf844, buf835, buf838, buf841, primals_43, add_1297, rsqrt_8, s0, 4096, stream=stream0)
        del primals_43
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf855, buf849, buf852, primals_39, add_1232, rsqrt_7, s0, 4096, stream=stream0)
        del primals_39
        ...
        del permute_1297
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf858 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf857, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_13, view_78, view_79, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_12, getitem_13, getitem_14, getitem_15, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_13
        del getitem_12
        del getitem_13
        del getitem_14
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf874, buf865, buf868, buf871, primals_34, add_994, rsqrt_6, s0, 4096, stream=stream0)
        del primals_34
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf885, buf879, buf882, primals_30, add_929, rsqrt_5, s0, 4096, stream=stream0)
        del primals_30
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf904, buf895, buf898, buf901, primals_25, add_691, rsqrt_4, s0, 4096, stream=stream0)
        del primals_25
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_4.run(buf915, buf909, buf912, primals_21, add_626, rsqrt_3, s0, 4096, stream=stream0)
        del primals_21
        ...
        del permute_1363
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention_backward]
        buf918 = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(reinterpret_tensor(buf917, (1, 32, s0, 128), (4096*s0, 128, 4096, 1), 0), clone_7, view_38, view_39, reinterpret_tensor(constant_pad_nd, (1, 32, s0, s0), (s0*s0 + 8*s0 + (-1)*s0*(s0 % 8), 0, 8 + s0 + (-1)*(s0 % 8), 1), 0), getitem_4, getitem_5, getitem_6, getitem_7, 0.0, [True, True, True, False], scale=0.08838834764831845)
        del clone_7
        del getitem_4
        del getitem_5
        del getitem_6
        ...
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_div_mul_pow_sum_10.run(buf934, buf925, buf928, buf931, primals_16, add_388, rsqrt_2, s0, 4096, stream=stream0)
        del primals_16
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    embedding = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    bmm = rand_strided((1, 64, 11), (704, 11, 1), device='cuda:0', dtype=torch.float32)
    rsqrt = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_9 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_18 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_19 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_4 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    constant_pad_nd = rand_strided((1, 1, 11, 16), (176, 176, 16, 1), device='cuda:0', dtype=torch.float16)
    getitem = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    mm_3 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_1 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_23 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_4 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_5 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_27 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_388 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_2 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_29 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_38 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_39 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_7 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_4 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_626 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_3 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_43 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_11 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_12 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_47 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_691 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_4 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_49 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_58 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_59 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_10 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_8 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_929 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_5 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_63 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_18 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_19 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_67 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_994 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_6 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_69 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_78 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_79 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_13 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_12 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_1232 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_7 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_83 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_25 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_26 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_87 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_1297 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_8 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_89 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_98 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_99 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_16 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_16 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_1535 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_9 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_103 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_32 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_33 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_107 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_1600 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_10 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_109 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_118 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_119 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_19 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_20 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_1838 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_11 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_123 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_39 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_40 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_127 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_1903 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_12 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_129 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_138 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_139 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_22 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_24 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_2141 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_13 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_143 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_46 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_47 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_147 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_2206 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_14 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_149 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_158 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_159 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_25 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_28 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_2444 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_15 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_163 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_53 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_54 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_167 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_2509 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_16 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_169 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_178 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_179 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_28 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_32 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_2747 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_17 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_183 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_60 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_61 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_187 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_2812 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_18 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_189 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_198 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_199 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_31 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_36 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_3050 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_19 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_203 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_67 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_68 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_207 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_3115 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_20 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_209 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_218 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_219 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_34 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_40 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_3353 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_21 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_223 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_74 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_75 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_227 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_3418 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_22 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_229 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_238 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_239 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_37 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_44 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_3656 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_23 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_243 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_81 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_82 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_247 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_3721 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_24 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_249 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_258 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_259 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_40 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_48 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_3959 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_25 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_263 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_88 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_89 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_267 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_4024 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_26 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_269 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_278 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_279 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_43 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_52 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_4262 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_27 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_283 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_95 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_96 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_287 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_4327 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_28 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_289 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_298 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_299 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_46 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_56 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_4565 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_29 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_303 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_102 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_103 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_307 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_4630 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_30 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_309 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_318 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_319 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_49 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_60 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_4868 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_31 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_323 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_109 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_110 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_327 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_4933 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_32 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_329 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_338 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_339 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_52 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_64 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_5171 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_33 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_343 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_116 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_117 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_347 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_5236 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_34 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_349 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_358 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_359 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_55 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_68 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_5474 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_35 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_363 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_123 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_124 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_367 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_5539 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_36 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_369 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_378 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_379 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_58 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_72 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_5777 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_37 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_383 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_130 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_131 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_387 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_5842 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_38 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_389 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_398 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_399 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_61 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_76 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_6080 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_39 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_403 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_137 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_138 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_407 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_6145 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_40 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_409 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_418 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_419 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_64 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_80 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_6383 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_41 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_423 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_144 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_145 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_427 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_6448 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_42 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_429 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_438 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_439 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_67 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_84 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_6686 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_43 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_443 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_151 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_152 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_447 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_6751 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_44 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_449 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_458 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_459 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_70 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_88 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_6989 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_45 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_463 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_158 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_159 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_467 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_7054 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_46 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_469 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_478 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_479 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_73 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_92 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_7292 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_47 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_483 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_165 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_166 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_487 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_7357 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_48 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_489 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_498 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_499 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_76 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_96 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_7595 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_49 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_503 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_172 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_173 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_507 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_7660 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_50 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_509 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_518 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_519 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_79 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_100 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_7898 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_51 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_523 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_179 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_180 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_527 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_7963 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_52 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_529 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_538 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_539 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_82 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_104 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_8201 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_53 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_543 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_186 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_187 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_547 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_8266 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_54 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_549 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_558 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_559 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_85 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_108 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_8504 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_55 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_563 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_193 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_194 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_567 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_8569 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_56 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_569 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_578 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_579 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_88 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_112 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_8807 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_57 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_583 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_200 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_201 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_587 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_8872 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_58 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_589 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_598 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_599 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_91 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_116 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_9110 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_59 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_603 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_207 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_208 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_607 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_9175 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_60 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_609 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_618 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_619 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_94 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_120 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_9413 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_61 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_623 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_214 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_215 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_627 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_9478 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_62 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_629 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    view_638 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    view_639 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    clone_97 = rand_strided((1, 32, 11, 128), (45056, 1408, 128, 1), device='cuda:0', dtype=torch.float16)
    getitem_124 = rand_strided((1, 32, 11, 128), (45056, 128, 4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    add_9716 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_63 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_643 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    mm_221 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    mm_222 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    view_647 = rand_strided((11, 14336), (14336, 1), device='cuda:0', dtype=torch.float16)
    add_9781 = rand_strided((1, 11, 4096), (45056, 4096, 1), device='cuda:0', dtype=torch.float16)
    rsqrt_64 = rand_strided((1, 11, 1), (11, 1, 1), device='cuda:0', dtype=torch.float32)
    view_649 = rand_strided((11, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    ...
    tangents_1 = rand_strided((1, 11, 128256), (1410816, 128256, 1), device='cuda:0', dtype=torch.float16)
